...
@Component({
  selector: 'app-watertankreport',
  templateUrl: './watertankreport.component.html',
  styleUrls: ['./watertankreport.component.scss']
})
export class WatertankreportComponent implements OnInit {
  ...
  getdata(det){
    ...
    this.ds.getData('/waterTANKReport',data1).then((data:any) => {
