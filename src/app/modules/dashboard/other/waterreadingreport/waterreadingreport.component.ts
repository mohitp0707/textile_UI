...
@Component({
  selector: 'app-waterreadingreport',
  templateUrl: './waterreadingreport.component.html',
  styleUrls: ['./waterreadingreport.component.scss']
})
export class WaterreadingreportComponent implements OnInit {
  amt:any;
  p: number = 1;
  stockData:any=[];
  ...
  getdata(det){
    ...
    this.ds.getData('/waterreadReport',data1).then((data:any) => {
